...
class CommandsDb:
    ...
    COMMANDS_INSERT = [
        COMMAND_INSERT_GRADIENT,
        COMMAND_INSERT_GRADIENT,
        COMMAND_INSERT_SECOND_COLOR,
        COMMAND_INSERT_THIRD_COLOR,
    ]
    ...
    COMMANDS_SELECT = [
        COMMAND_SELECT_GRADIENT,
        COMMAND_SELECT_FIRST_COLOR,
        COMMAND_SELECT_SECOND_COLOR,
        COMMAND_SELECT_THIRD_COLOR,
    ]
    ...
    COMMANDS_DELETED = [
        COMMAND_DELETED_GRADIENT_COLOR,
        COMMAND_DELETED_FIRST_COLOR,
        COMMAND_DELETED_SECOND_COLOR,
        COMMAND_DELETED_THIRD_COLOR,
    ]
